...
- Event class: [GenericLootEventJS](https://github.com/KubeJS-Mods/KubeJS/tree/1902/common/src/main/java/dev/latvian/mods/kubejs/loot/GenericLootEventJS.java)
