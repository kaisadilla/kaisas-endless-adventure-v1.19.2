...
- Event class: [ItemTooltipEventJS](https://github.com/KubeJS-Mods/KubeJS/tree/1902/common/src/main/java/dev/latvian/mods/kubejs/item/ItemTooltipEventJS.java)
