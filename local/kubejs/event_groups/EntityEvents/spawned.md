...
- Event class: [EntitySpawnedEventJS](https://github.com/KubeJS-Mods/KubeJS/tree/1902/common/src/main/java/dev/latvian/mods/kubejs/entity/EntitySpawnedEventJS.java)
